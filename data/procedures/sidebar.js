var procedures = {
    "Introduction": [
        {
            "Being Organized":
            "Managing activities and accomplishing them requires \
            oraginizing. Having able to manage activities and accomplish them \
            in a well structured manner will increase productivity. \
            "
        },

        {
            "Tracking":
            "Productivity will increase and priorities would be well defined. \
            Employees will be able to keep track the progress and goals. \
            A well arranged tasks and activities will alliviate the complexity of the work  .  \
            "
        },
    ],
    ...
    "Objective": [
        {
            "The document":
            "The purpose of this section is to assist a Quality Assurance \
            officer in creating a Sprint Score. This will help on being familliarized \
            to the definition, function and procedure in creating QA Sprint Score \
            "
        },

        {
            "Beneficiaries":
            "This wiki website would be helpful to those who are aspiring \
            to work in the field of Quality Assurance. This also give students, beginners, or even \
            professionals a place to reference the procedures \
            "
        }
    ...
    "Sprint Scores": [
        {
            ...
            "The scores of the employees are averaged \
            at the end of each sprint. It becomes the sprint score.\
             One of the metrics used to track the efficiency is to track \
             the performance of QA activities and tasks. \
             Designing the QA process is vital to the project's success  "
        },
        ...
        {
            "Role in testing":
            "QA Sprint Score provideds a way to evaluate the overall performance of the team. \
            The progress, efficiency, and effectiveness are guided by the \
            QA Sprint Score thus enforcing employees to have the \
            desired result. \
            "
        },
    ...
    [
        {
            "Creating Task Card":
            `
            The first step to creating a QA sprint score is to create a task card by going through the sprints tab under boards and adding a new work item. The following are necessary to be filled or entered for this specific part:
            ...
            The following are the states used on a task card:
                ...
                f.	Effort hours - The generic numeric field the team gets to set regarding the amount of work required to complete a task.
                    ●	i. Original Estimate
                    ●	ii. Completed
